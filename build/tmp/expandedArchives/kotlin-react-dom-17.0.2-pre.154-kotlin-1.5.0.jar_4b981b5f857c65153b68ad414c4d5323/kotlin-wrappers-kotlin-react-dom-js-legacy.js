(function (root, factory) {
  ...
  RDOMBuilder.prototype.attrs_1wdtl9$ = defineInlineFunction('kotlin-wrappers-kotlin-react-dom-js-legacy.react.dom.RDOMBuilder.attrs_1wdtl9$', function (handler) {
    handler(this.attrs);
  });
  ...
  var objectTag = defineInlineFunction('kotlin-wrappers-kotlin-react-dom-js-legacy.react.dom.objectTag_hy8adv$', wrapFunction(function () {
    ...
    return function ($receiver, classes, block) {
      if (classes === void 0)
        classes = null;
      var $receiver_0 = new RDOMBuilder_init(objectTag$lambda(classes));
      block($receiver_0);
      return $receiver.child_52psg1$($receiver_0.create());
    };
  }));
  ...
  var picture = defineInlineFunction('kotlin-wrappers-kotlin-react-dom-js-legacy.react.dom.picture_2zheom$', wrapFunction(function () {
    ...
    return function ($receiver, classes, block) {
      if (classes === void 0)
        classes = null;
      var $receiver_0 = new RDOMBuilder_init(picture$lambda(classes));
      block($receiver_0);
      return $receiver.child_52psg1$($receiver_0.create());
    };
  }));
  ...
  var varTag = defineInlineFunction('kotlin-wrappers-kotlin-react-dom-js-legacy.react.dom.varTag_wqfjdr$', wrapFunction(function () {
    ...
    return function ($receiver, classes, block) {
      if (classes === void 0)
        classes = null;
      var $receiver_0 = new RDOMBuilder_init(varTag$lambda(classes));
      block($receiver_0);
      return $receiver.child_52psg1$($receiver_0.create());
    };
  }));
