(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'react', 'kotlin-wrappers-kotlin-extensions-js-legacy', 'kotlinx-coroutines-core'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('react'), require('kotlin-wrappers-kotlin-extensions-js-legacy'), require('kotlinx-coroutines-core'));
  else {
    if (typeof kotlin === 'undefined') {
      ...
      throw new Error("Error loading module 'kotlin-wrappers-kotlin-react-js-legacy'. Its dependency 'kotlinx-coroutines-core' was not found. Please, check whether 'kotlinx-coroutines-core' is loaded prior to 'kotlin-wrappers-kotlin-react-js-legacy'.");
    }root['kotlin-wrappers-kotlin-react-js-legacy'] = factory(typeof this['kotlin-wrappers-kotlin-react-js-legacy'] === 'undefined' ? {} : this['kotlin-wrappers-kotlin-react-js-legacy'], kotlin, react, this['kotlin-wrappers-kotlin-extensions-js-legacy'], this['kotlinx-coroutines-core']);
  }
}(this, function (_, Kotlin, $module$react, $module$kotlin_wrappers_kotlin_extensions_js_legacy, $module$kotlinx_coroutines_core) {
  'use strict';
  ...
  RBuilder.prototype.child_t7en6a$ = defineInlineFunction('kotlin-wrappers-kotlin-react-js-legacy.react.RBuilder.child_t7en6a$', wrapFunction(function () {
  ...
  RBuilder.prototype.childFunction_khdow9$ = defineInlineFunction('kotlin-wrappers-kotlin-react-js-legacy.react.RBuilder.childFunction_khdow9$', wrapFunction(function () {
    var getKClass = Kotlin.getKClass;
  ...
  RBuilder.prototype.node_e2hqbc$ = defineInlineFunction('kotlin-wrappers-kotlin-react-js-legacy.react.RBuilder.node_e2hqbc$', wrapFunction(function () {
    var emptyList = Kotlin.kotlin.collections.emptyList_287e2$;
    var getKClass = Kotlin.getKClass;
  ...
  var buildElement = defineInlineFunction('kotlin-wrappers-kotlin-react-js-legacy.react.buildElement_zepujl$', wrapFunction(function () {
  ...
  var useState = defineInlineFunction('kotlin-wrappers-kotlin-react-js-legacy.react.useState_mh5how$', wrapFunction(function () {
  ...
  var useState_0 = defineInlineFunction('kotlin-wrappers-kotlin-react-js-legacy.react.useState_klfg04$', wrapFunction(function () {
    var rawUseState = _.$$importsForInline$$.react.useState;
    var Any = Object;
    var throwCCE = Kotlin.throwCCE;
    var RStateDelegate_init = _.react.RStateDelegate;
